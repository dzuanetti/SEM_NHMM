###########################################################################
#                                                                         #
#            APPLICATION Global LASSO - 2 ESTADOS OCULTOS                 #
#                                                                         #
###########################################################################
...
tol<-0.0000000001 #Nivel de tolerancia que estabelecemos como criterio de parada do EM Est
tolval=NULL
tolval[1]=1
...
mainDir = paste("/home/gustavo/Documents/Academic/Cenarios/Application/Code/K2/Global",sep = "")
...
arima_mod <- auto.arima(y=Y_tr, xreg = data.matrix(X_tr))
...
Algo <- c("MSPE_NHMM_Global", "MSPE_ARIMA", "MSPE_GLMNET")
